    ...
    <section id="beranda" style={{
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '18px', flexWrap: 'wrap' }}>
          <span style={{ fontSize: '0.82rem', color: 'var(--gold-400)', fontWeight: 700, letterSpacing: '0.05em' }}>
            BERANDA
          </span>
          <span style={{ color: 'var(--slate-500)', fontSize: '0.82rem' }}>/</span>
          <span style={{ fontSize: '0.82rem', color: 'var(--slate-300)', fontWeight: 500 }}>
        ...
        <div style={{
          ...
          <div>
            <div className="section-badge dark">
              <Award size={14} color="var(--gold-400)" />
            ...
            <div style={{ display: 'flex', gap: '20px', marginTop: '30px', flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--slate-300)', fontSize: '0.88rem' }}>
          ...
          <div>
            <div style={{
              ...
              <h3 style={{ color: 'var(--white)', fontSize: 'clamp(1.2rem, 1.8vw, 1.45rem)', marginBottom: '12px', lineHeight: 1.3 }}>
                Keunggulan Distribusi & Kebijakan Strategis yang Terintegrasi
              </h3>

              <p style={{ color: 'var(--slate-300)', fontSize: '0.92rem', lineHeight: 1.6, marginBottom: '20px' }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '0.8rem', color: 'var(--gold-400)', fontWeight: 700, textTransform: 'uppercase', marginBottom: '3px' }}>
                  Fokus Kami
                </div>
                <div style={{ fontSize: '0.88rem', color: 'var(--slate-200)', lineHeight: 1.45 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '14px', borderTop: '1px solid rgba(255, 255, 255, 0.08)' }}>
                <div>
                  <div style={{ fontSize: '0.72rem', color: 'var(--slate-400)', textTransform: 'uppercase' }}>Entitas Resmi</div>
                  <div style={{ fontSize: '0.92rem', color: 'var(--white)', fontWeight: 700 }}>{info.legalName}</div>
                </div>
                <a href="#pengurus" style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', color: 'var(--gold-400)', fontSize: '0.85rem', fontWeight: 600 }}>
